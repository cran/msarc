...
###################################################
### code chunk number 1: msarc.Rnw:69-89
###################################################
library(msarc)
# load data
...
sample <- msarc.findGOterms(sample)
# get the list as a data frame
term_df <- msarc.getTerms(sample)
term_df <- term_df[c("GO:0017076","GO:0030554","GO:0032553","GO:0032555",
                     "GO:0032559","GO:0035639","GO:0036094","GO:0097159",
                     "GO:0017111","GO:0016462"),]
